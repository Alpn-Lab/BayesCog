...
This website is an adapted version of teaching materials originally made for the <ins>award winning</ins>\* **BayesCog** seminar at the [Faculty of Psychology](https://psychologie.univie.ac.at/), [University of Vienna](https://www.univie.ac.at/en/), as part of the Advanced Seminar for master's students (Mind and Brain track; recorded during Summer Term 2020/2021).
Further content from the [BayesCog workshop at UKE Hamburg](https://github.com/lei-zhang/BayesCog_Part1) (2023) have also been added[^1]. 
...
In the course, students will be formally grounded in key principles of cognitive modeling including Bayesian statistics[^2] and reinforcement learning. 
...
![](images/introduction/cc_by_sa.png){width="13%"}
...
```tex
Zhang, L., & Sohail, A. (2025). BayesCog: Bayesian statistics and hierarchical Bayesian modeling for psychological science. [Lesson]. Zenodo. https://doi.org/10.5281/zenodo.15870394
```
