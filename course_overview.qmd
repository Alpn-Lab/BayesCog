...
Running the container for the first time will prevent further input in the terminal. You can exit this using `Ctrl/Cmd+C`. You will not need to install any packages, only to load them when running various operations.
