...
![](/images/01.R_basics/marginal_distribution.png){fig-align="center" width="60%"}
...
**Bayes' theorem is a fundamental concept in probability theory that helps us update our knowledge about events based on new evidence.**
...
- $p(A)$ is the prior probability - our prior knowledge about event A
...
**So what Bayes' theorem tells us is that we can find the probability of an event A happening, given that we observed event B, by using our prior knowledge about both events. It's equivalent to updating what we know based on new information.**
...
This allows us to update our knowledge about the temperature with each new observation of rain.
