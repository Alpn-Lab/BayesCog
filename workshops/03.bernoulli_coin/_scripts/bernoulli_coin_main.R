...
# setwd('...//workshops/03.bernoulli_coin')
...
# change the variable to either fit_coin1 or 2 depending on the model
print(fit_coin1)
...
plot_dens <- stan_plot(fit_coin1, pars = 'theta', show_density = T , fill_color="skyblue")
print(plot_dens)