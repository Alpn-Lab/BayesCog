...
modelFile <- '_scripts/exp_decay_model_master.stan' # A.S. changed from 'model2' because no stan model existed with that name, and added theta parameter

cat("Estimating", modelFile, "model... \n")
startTime = Sys.time(); print(startTime)
cat("Calling", nChains, "simulations in Stan... \n")

# A.S. changed name of stanfit file from fit_mem to fit_coin1
...
# A.S. changed name of some variables from fit_coin2 to fit_coin1
# A.S. This code only works if you include theta in the parameters/transformed parameters block (see exp_decay_model_master_as.stan)
...
plot_dens <- stan_plot(fit_coin1, pars = 'theta', show_density = T)
