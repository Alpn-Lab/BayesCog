...
- Explain the principles of cognitive modeling and what parameters represent
- Describe the Rescorla-Wagner learning rule and its parameters
- Build and fit a simple Rescorla-Wagner model in Stan
- Interpret estimated parameters for the Rescorla-Wagner model
