...
- Explain the benefits of hierarchical models for modeling populations
- Specify a hierarchical Rescorla-Wagner model with group and individual-level parameters in Stan
- Apply non-centered reparameterization to improve sampling
- Adjust Stan's sampling parameters to aid fitting
