...
- Explain how data and parameters are linked through the likelihood
- Estimate a posterior distribution using grid approximation in `R`
- Understand Markov chain Monte Carlo (MCMC) and how it can be used for Bayesian inference
